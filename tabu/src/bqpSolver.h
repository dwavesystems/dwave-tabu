...
class BQPSolver
{
    public:
         ...
         * \return BQP containing best solution found
         */
        BQP multiStartTabuSearch(long long timeLimitInMilliSecs, int numStarts, int tabuTenure, const std::vector<int> &initSolution, const bqpSolver_Callback *callback);
