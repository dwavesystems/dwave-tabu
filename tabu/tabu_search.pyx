...
cdef class TabuSearch:
    ...
    def __cinit__(self, object Q, object initSol, int tenure, long int timeout, object seed=None) :
        ...
        with nogil:
            self.c_tabu = new tabu.TabuSearch(Qvec, initVec, tenure, timeout, _seed)
